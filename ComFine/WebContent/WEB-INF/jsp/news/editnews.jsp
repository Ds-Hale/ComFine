...
<script type="text/javascript">    
 ...
 prevDiv.innerHTML = '<img src="' + evt.target.result + '" />'+testValue;  
}    
 reader.readAsDataURL(file.files[0]);  
}  
 else    
 {  
 prevDiv.innerHTML = '<div class="img" style="filter:progid:DXImageTransform.Microsoft.AlphaImageLoader(sizingMethod=scale,src=\'' + file.value + '\'"></div>'+testValue;  
 }  
 }  
 </script>  
...
<div class="fabu">
	<form action="editnews.action" method="post"  enctype="multipart/form-data"  class="bootstrap-frm">
<div ><h1>新闻发布
<span>惠家网新闻发布</span>
</h1>
</div>
...
<input id="name" type="text" name="title" placeholder="新闻标题" value="${news.getTitle()}"/>
</label>
<label>
<span>UP主</span>
<input id="email" type="text" name="up" placeholder="up主"  value="${news.getUp()}"/>
</label>
<label>
<span>新闻类容 :</span>
<textarea id="message" name="content" placeholder="新闻内容" >${news.getContent()}
</textarea>
